...
2 launch basecall server                                  # dna_r10.4.1_e8.2_400bps_5khz_fast.cfg
...
python3 /nfs/research/goldman/lukasw/simION/code/01_playback/start_protocol_mod.py --position MS00000 --kit SQK-LSK114 --pod5 --fastq --basecalling --fastq-reads-per-file 1000 --pod5-reads-per-file 1000
# NO BASECALLING
#python3 /nfs/research/goldman/lukasw/simION/code/01_playback/start_protocol_mod.py --position MS00000 --kit SQK-LSK114 --pod5
