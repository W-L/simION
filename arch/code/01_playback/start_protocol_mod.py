...
def add_protocol_ids(experiment_specs, args):
    for spec in experiment_specs:
        ...
        # TODO comment out exit when no protocol found
        ...
        # TODO hard-coded protocol
        prot = "sequencing/sequencing_MIN114_DNA_e8_2_400K:FLO-MIN114:SQK-LSK114:400"
        print(prot)
        spec.protocol_id = prot
